...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; scroll-behavior: smooth; color-scheme: dark; }
        ...
        .cursor-trail {
            ...
            box-shadow: 0 0 15px var(--accent); transition: transform 0.1s ease;
...
<header>
    <div class="nav-container">
        <div class="logo">
            <i class="fa-solid fa-terminal"></i> Mohamed Antar
...
<div class="container" id="projects">
    ...
    <div class="grid">
        ...
        <div class="card">
            <h3><i class="fa-solid fa-code" style="color: var(--accent);"></i> Python Automation</h3>
...
<div class="container" id="gallery">
    ...
    <div class="showcase-grid">
        <div class="media-box">
            <h3 style="color: var(--accent); margin-bottom: 10px; font-size: 1rem;">Asmaa Clinic Design</h3>
            <img src="IMG-20260630-WA0006.jpg" alt="Asmaa Clinic" onclick="openLightbox(this.src)">
        </div>
        <div class="media-box">
            <h3 style="color: var(--accent); margin-bottom: 10px; font-size: 1rem;">Minecraft Thumbnail</h3>
...
<div class="container" id="contact">
    ...
    <div class="card" style="max-width: 600px; margin: auto; text-align: center;">
        <p style="margin: 10px 0;"><i class="fa-solid fa-envelope" style="color: var(--accent);"></i> Email: <span>moamedantar8@gmail.com</span></p>
        ...
        <button class="btn" style="margin-top: 15px;" onclick="copyEmail()"><i class="fa-solid fa-copy"></i> Copy Email Address</button>
    </div>
</div>
...
<script>
    ...
    function copyEmail() {
        ...
        toast.innerHTML = `<i class="fa-solid fa-circle-check" style="color: #22c55e; font-size: 1.3rem;"></i><div><div style="font-weight: bold;">Copied!</div><div style="font-size: 0.85rem; color: var(--text-muted);">Email copied to clipboard.</div></div>`;
